        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(DocumentsActivity.this, Login.class);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                eventlist.add(0, new Document(
                                        user.getString("update_rule_file_id"),
                                        user.getString("update_rule_file"),
                                        user.getString("update_rule_file_date"),
                                        user.getString("update_rule_file_type"),
                                        user.getString("update_rule_file_for"),
                                        user.getString("update_rule_file_loca")
                            ...
                            DocumentAdapter adapter1 = new DocumentAdapter(getApplicationContext(), eventlist);
