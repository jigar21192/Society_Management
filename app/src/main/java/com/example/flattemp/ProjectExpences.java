...
import com.example.flattemp.Adaptor.Project_Expences_Adapter;
...
public class ProjectExpences extends AppCompatActivity implements  Project_Expences_Adapter.OnItemClickListener{
    RecyclerView eventrecycler;
    List<Project_Expences_Model> eventlist;
    SwipeRefreshLayout pullToRefresh;
    Project_Expences_Adapter adapter;
    String mem_id;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_project_expences);
        ...
        eventrecycler.setLayoutManager(new LinearLayoutManager(ProjectExpences.this));

        eventlist = new ArrayList<>();
        adapter=new Project_Expences_Adapter(getApplicationContext(),eventlist);
        adapter.setOnItemClickListener(ProjectExpences.this);
