...
public class Main2Activity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item){
        ...
        if (id == R.id.nav_home) {
            i=new Intent(this,Main2Activity.class);startActivity(i);
            ...
            Intent intent = new Intent(Main2Activity.this,Complain.class);
            startActivity(intent);

        }else if (id == R.id.nav_chairman) {
            Intent intent = new Intent(Main2Activity.this,ScrollingActivityChairman.class);
            startActivity(intent);
