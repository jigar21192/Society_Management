...
import com.example.flattemp.Adaptor.View_Complain_Adapter;
...
public class Viewcomplain extends AppCompatActivity {
    List<View_Complain_Model> visitorlist;
        ...
        alertDialogBuilder.setPositiveButton("Yes",
                new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        ...
                        Intent intent = new Intent(Viewcomplain.this, Login.class);
    ...
    private void loadUsers() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, UrlsList.fetch_complain,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            View_Complain_Adapter adapter1 = new View_Complain_Adapter(getApplicationContext(), visitorlist);
